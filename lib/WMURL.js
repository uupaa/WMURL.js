...
function _createURLObject(obj) { // @arg URLObject - { href, protocol,         auth, hostname, port,                     pathname, search, hash }
                                 // @ret URLObject - { href, protocol, origin, host, hostname, port, username, password, pathname, search, hash,
                                 //                    scheme, path, dir, file, fragment }
    var auth = (obj["auth"] || ":").split(":"); // [username, password]
