...
WMURL["cacheBusting"]=WMURL_cacheBusting; // WMURL.cacheBusting(url:URLString, keyword:ASCIIString = "t"):URLString
...
function WMURL_cacheBusting(url,       // @arg URLString
                            keyword) { // @arg ASCIIString = "t"
                                       // @ret URLString
//{@dev
    $valid($type(url,  "URLString"), WMURL_cacheBusting, "url");
    $valid($type(keyword, "String"), WMURL_cacheBusting, "keyword");
    if (keyword) {
        $valid(/[A-Za-z_]+/.test(keyword), WMURL_cacheBusting, "keyword");
    }
//}@dev
