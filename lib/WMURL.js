...
WMURL["valid"]      = WMURL_valid;        // WMURL.valid(url:URLString|URLStringArray, canonical:Boolean = false):Boolean
...
// --- implements ------------------------------------------
function WMURL_valid(url,         // @arg URLString|URLStringArray - absolute/relative url(s)
                     canonical) { // @arg Boolean = false - TBD
                                  // @ret Boolean
                                  // @desc validate URL
//{@dev
    $valid($type(url,       "URLString|URLStringArray"), WMURL_valid, "url");
    $valid($type(canonical, "Boolean|omit"),             WMURL_valid, "canonical");
//}@dev
